...
manifest='{"name":"sharenow","source":"AsyncFuncAI/sharenow","version":"1.17.0","latestVersion":"1.17.0","minimumVersion":"1.17.0","files":[{"path":"SKILL.md","sha256":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"}]}'
