...
REQUIRED_PATHS=(
  ...
  "sharenow/scripts/channel.sh"
  "sharenow/scripts/fullstack.sh"
  "sharenow/scripts/kb.sh"
  ...
  "skills/sharenow/scripts/channel.sh"
  "skills/sharenow/scripts/fullstack.sh"
  "skills/sharenow/scripts/kb.sh"
  "skills/sharenow/scripts/version.sh"
  ...
  "hermes/productivity/sharenow/scripts/channel.sh"
  "hermes/productivity/sharenow/scripts/fullstack.sh"
  "hermes/productivity/sharenow/scripts/kb.sh"
